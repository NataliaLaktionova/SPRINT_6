...
class TestOrderPageOrder:
    @allure.title('Тестирование позитивного кейса оформления заказа самоката с 2 наборами данных')
    @pytest.mark.parametrize('button, test_data', [(MainPageLocators.ORDER_BUTTON_IN_HEADER, TestData.TEST_Person1), (MainPageLocators.ORDER_BUTTON_IN_MAIN, TestData.TEST_Person2)])
